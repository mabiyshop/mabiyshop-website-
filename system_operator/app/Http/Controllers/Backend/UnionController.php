    ...
    public function generate(){
        ...
        if($upazilas){
            foreach($upazilas as $upazila){
                $areas_pathao = \Helper::getPathaoAreas($upazila->zone_id);
                $areas = $areas_pathao->data;
                if($areas){
                    foreach($areas->data as $area){
                        $Union = new Union();
                        $Union->area_id = $area->area_id;
                        $Union->upazila_id = $upazila->id;
        ...
        return redirect()->route('admin.location.union')->with('success', 'Areas successfully generated!');
    }
}