...
class SettingsController extends Controller
{
    ...
    public function environmentStore(Request $request)
    {
        ...
        file_put_contents(app()->environmentFilePath(), str_replace(
            'PATHAO_CLIENT_USER_NAME' . '=' . env('PATHAO_CLIENT_USER_NAME'),
            'PATHAO_CLIENT_USER_NAME' . '=' . $request->pathao_user_name,
            file_get_contents(app()->environmentFilePath())
        ));

        file_put_contents(app()->environmentFilePath(), str_replace(
            'PATHAO_CLIENT_PASSWORD' . '=' . env('PATHAO_CLIENT_PASSWORD'),
            'PATHAO_CLIENT_PASSWORD' . '=' . $request->pathao_password,
            file_get_contents(app()->environmentFilePath())
        ));
