                ...
                @if(\Auth::user()->getRoleNames() != '["seller"]')
                  ...
                  @endif
                      ...
                      @if(\Auth::user()->getRoleNames() != '["seller"]')
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Is Branch</label>
                            <div class="col-sm-8">
                               <div class="form-check form-check-flat">
                                  <label class="switch"><input name="is_branch" type="checkbox" @if($vendor->is_branch) checked @endif ><span class="slider round"></span></label>
                               </div>
                            </div>
                         </div>
                        </div>
                      @else
                        <label class="col-md-6 col-form-label">
                          @if($vendor->is_branch == 1)
                            <p><b>Is Branch:</b> <span style="color:green">Yes</span></p>
                          @else
                          <p><b>Is Branch:</b> <span style="color:red">No</span></p>
                          @endif
                      </label>
                      @endif
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Pathao Store Id</label>
                          <div class="col-sm-8">
                             <div class="form-check form-check-flat">
                                <input name="pathao_store_id" type="text" class="form-control" value="{{ $vendor->pathao_store_id ?? '' }}">
                             </div>
                          </div>
                       </div>
                      </div>
                    @else
                      <label class="col-md-6 col-form-label">
                        <label class="col-sm-4 col-form-label">Pathao Store Id: {{ $vendor->pathao_store_id ?? '' }}</label>
                    </label>
                    @endif
