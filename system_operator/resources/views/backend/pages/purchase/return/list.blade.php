...
@section('title', 'Purchase Purchase Return List - ' . config('concave.cnf_appname'))
@section('content')
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <span class="card-title">Dashboard > Purchase Return</span>
                <a class="btn btn-success float-right" href="{{ route('admin.purchase.return.create') }}">Create New Purchase Return</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="purchase_quick_view_modal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title" id="">Return Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@push('footer')
    <script type="text/javascript">
        var table = jQuery('#dataTable').DataTable({
            ...
            autoWidth: true,
            ajax: {
                url: "{{ route('admin.get.purchase.return.list', 0) }}",
                type: 'GET',
            },
            "order": [
                [0, 'desc']
        ...
        jQuery(document).on('click', '.purchase_quick_view_btn', function(e) {
            e.preventDefault();
            jQuery.ajax({
                url: "/admin/purchase/return/view/" + jQuery(this).attr('data-id'),
                type: "get",
                data: {},
