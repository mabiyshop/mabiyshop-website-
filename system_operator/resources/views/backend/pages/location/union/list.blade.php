...
@section('title', 'Union List - ' . config('concave.cnf_appname'))
@section('content')
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-info float-right mr-1" href="{{ route('admin.location.union.generate') }}">Generate Area From Pathao</a>
            </div>
        </div>
    </div>
