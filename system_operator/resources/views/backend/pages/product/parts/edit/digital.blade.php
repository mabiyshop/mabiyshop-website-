                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="max_cart_qty"class="form-control"
                                                value="{{ $product->max_cart_qty ?? 100 }}">
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="SEO" role="tabpanel">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                value="{{ $product->tag ?? 'Mabiy Shop, Khushbu, Perfume oil, Natural Perfume Oil, Fragrances, Online Shopping, Attar,' }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                value="{{ App\Models\ProductMeta::where('product_id', $product->id)->where('meta_key', 'meta_keyword')->first()->meta_value ?? 'Mabiy Shop, Khushbu, Perfume oil, Natural Perfume Oil, Fragrances, Online Shopping, Attar,' }}"
