                        ...
                        <table id="listTable" class="table">
                            ...
                            @foreach ($address as $row)
                              <tr class="row{{$row->id}}">
                                  ...
                                  <td data-defualt="{{$row->is_defualt}}">{{ $row->is_defualt }}</td>
              ...
              <div class="modal-body">
                <form class="form-sample" method="post" action="{{ route('admin.user.address.update')}}" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Make Defualt Address</label>
                            <div class="col-sm-8">
                              <div class="form-check form-check-flat">
                                <label class="form-check-label">
                                    <label class="switch"><input name="defualt" id="defualt_address" type="checkbox"
    ...
    <script type="text/javascript">
       ...
       jQuery(document).on("change", "#division_id", function(){
        ...
        jQuery(document).on("click", ".edit_address", function(){
            ...
            var is_defualt = $('.row'+id).children('td').eq(6).attr('data-defualt');
            if (is_defualt == 'Yes') {
              $('#defualt_address').attr('checked', true);
            }else{
              $('#defualt_address').attr('checked', false);
            }
          });
