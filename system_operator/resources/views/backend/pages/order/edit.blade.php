	...
	<script type="text/javascript">
		jQuery(document).ready(function () {
	        ...
	        function calculateGrandTotal(){
	        	...
	        	jQuery("#order_grand_total").val((Number(subtotal) + Number(order_shipping_cost) + Number(order_packaging_cost) + Number(order_security_charge) + Number(order_vat) - Number(order_discount)).toFixed(2));
	        }
