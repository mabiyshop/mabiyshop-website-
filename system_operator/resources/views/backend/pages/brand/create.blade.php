                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <input type="text" name="meta_keyword" id="tag_field" placeholder="Meta Keyword" value="Mabiy Shop, Khushbu, Perfume oil, Natural Perfume Oil, Fragrances, Online Shopping, Attar," class="form-control" />
                              </div>
                          </div>
                      </div>
                      <div class="col-md-6">
