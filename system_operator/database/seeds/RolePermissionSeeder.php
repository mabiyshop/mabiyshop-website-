...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'marketing.single.product.offer',
            'marketing.single.product.offer.create',
            'marketing.single.product.offer.edit',
            'marketing.single.product.offer.delete',
            'marketing.single.product.offer.copy',
            'marketing.single.product.offer.notification',
            'marketing.single.product.offer.sms',
