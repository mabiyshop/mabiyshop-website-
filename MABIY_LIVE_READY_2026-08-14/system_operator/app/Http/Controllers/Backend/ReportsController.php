        ...
        return DataTables::of($data)->addIndexColumn()
            ...
            ->addColumn('shipping_name', function ($row) {
                if ($row->is_pickpoint == 1) {
                    ...
                    $shipping_name = optional($row->historical_shipping_address)->shipping_first_name . '' . optional($row->historical_shipping_address)->shipping_last_name;
                }
            ...
            ->addColumn('billing_phone', function ($row) {
                if ($row->is_pickpoint == 1) {
                    ...
                    $billing_phone = optional($row->historical_shipping_address)->shipping_phone;
                }
