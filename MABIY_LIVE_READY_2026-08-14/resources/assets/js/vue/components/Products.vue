<template>
        ...
        <div class="container">
            ...
            <div class="row search">
                ...
                <div class="col-12 col-sm-12 col-md-9  col-lg-9 search_product_div"> 
                    <div v-if="loadError" class="row search_page_row">
                        <div class="col-md-12 product_not_found">
                            <h5>We couldn't load the products. Please try again.</h5>
                            <button class="btn btn-primary" @click.prevent="load_search_product()">Retry</button>
                        </div>
                    </div>
                    <span v-else-if="searchProduct.data.length > 0">
    ...
    export default {
        ...
        methods:{
           ...
           load_categories(){
                axios.get(this.$baseUrl+'/api/v1/search-categories').then(response => {
                    this.categories = response.data && Array.isArray(response.data.data) ? response.data.data : [];
            ...
            load_brands(){
                axios.get(this.$baseUrl+'/api/v1/get-search-brands').then(response => {
                    this.brands = response.data && Array.isArray(response.data.data) ? response.data.data : [];
            ...
            load_search_product(page=1){
                ...
                axios.post(this.$baseUrl+'/api/v1/get-search-product', formData).then(response => {
                    if (!response.data || !response.data.products || !Array.isArray(response.data.products.data)) {
                    ...
                    this.all_next_page_url = '';
                    this.all_prev_page_url = '';
                    this.loadError = true;
                    this.loading = true;
                });
            },
        ...
        mounted(){
           ...
           document.title = "MabiY Shop | Products";
        }
