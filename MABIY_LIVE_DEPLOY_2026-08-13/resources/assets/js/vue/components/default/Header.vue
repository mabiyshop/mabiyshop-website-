                        ...
                        <div class="row text-left">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="header_shipping_district" v-model="resolvedShippingDistrict" @change="onManualDistrictChange" class="form-control" required>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="header_shipping_thana" v-model="resolvedShippingThana" @change="onManualThanaChange" class="form-control" :disabled="!resolvedShippingDistrict" required>
